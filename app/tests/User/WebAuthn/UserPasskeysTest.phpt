...
/** @testCase */
final class UserPasskeysTest extends TestCase
{
	...
	{
		Assert::same([], $this->userPasskeys->getPasskeys());
	}
	...
	public function testGetPasskeysSingleNeverUsed(): void
	{
		...
		$result = $this->userPasskeys->getPasskeys();
	...
	public function testGetCredentialNameById(): void
	{
		...
		Assert::same('My Phone', $this->userPasskeys->getCredentialNameById(Uuid::fromRfc4122(self::ID_1)));
	}
	...
	public function testGetCredentialNameByIdNotFound(): void
	{
		Assert::exception(function (): void {
			$this->userPasskeys->getCredentialNameById(Uuid::fromRfc4122(self::ID_1));
	...
	{
		$this->userPasskeys->renameCredential(Uuid::fromRfc4122(self::ID_1), 'New Name');
		Assert::same(
	...
	public function testRenameCredentialSameName(): void
	{
		...
		Assert::noError(function (): void {
			$this->userPasskeys->renameCredential(Uuid::fromRfc4122(self::ID_1), 'Same Name');
		});
	}
	...
	public function testDeleteCredential(): void
	{
		...
		$this->userPasskeys->deleteCredential(Uuid::fromRfc4122(self::ID_1));
		Assert::same(
...
TestCaseRunner::run(UserPasskeysTest::class);

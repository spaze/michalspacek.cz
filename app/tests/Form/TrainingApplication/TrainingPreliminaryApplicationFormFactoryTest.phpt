...
/** @testCase */
final class TrainingPreliminaryApplicationFormFactoryTest extends TestCase
{
	...
	public function __construct(
		...
		TrainingPreliminaryApplicationFormFactory $formFactory,
...
TestCaseRunner::run(TrainingPreliminaryApplicationFormFactoryTest::class);

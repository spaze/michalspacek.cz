...
/** @testCase */
final class TrainingPreliminaryApplicationsListFormFactoryTest extends TestCase
{
	...
	public function __construct(
		...
		TrainingPreliminaryApplicationsListFormFactory $formFactory,
...
TestCaseRunner::run(TrainingPreliminaryApplicationsListFormFactoryTest::class);

...
/** @testCase */
final class TrainingApplicationsListFormFactoryTest extends TestCase
{
	...
	public function __construct(
		...
		TrainingApplicationsListFormFactory $formFactory,
...
TestCaseRunner::run(TrainingApplicationsListFormFactoryTest::class);

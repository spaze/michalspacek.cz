	...
	private function allowList(): array
	{
		return [
			...
			'Presentation/Www/Trainings/training.latte' => [
				...
				'|formatPossiblyUnsafeHtml:"link:Www:CompanyTrainings:training {$training->getAction()}"' => 'admin-edited slug from trainings.action - same needle appears twice in this file',
			],

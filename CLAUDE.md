...
|---|---|---|
| `\|formatText` | `TexyFormatter::substitute()` / `translate()` | Any arg may be user-controlled — args are HTML-escaped and never interpreted as Texy markup |
